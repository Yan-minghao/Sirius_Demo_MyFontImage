...
public class SortListUtil<T> {
     ...
     * @return
     */
    public  List<?> sort(List<?> list, final String field) {
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    public  List<?> sort(List<?> list, String[] fields, String[] sorts) {
     ...
     * @return
     */
    public  List<?> sortByMethod(List<?> list, final String method) {
    ...
    public  List<?> sortByMethod(List<?> list, final String methods[],
                                       final String sorts[]) {
     ...
     * @return
     */
    public  boolean isImplementsOf(Class<?> clazz, Class<?> szInterface) {
        boolean flag = false;
